    ...
    <nav className={`navbar ${navScrolled ? 'scrolled' : ''}`}>
      <div className="container navbar-container">
        ...
        <ul className="nav-links">
          ...
          <li>
            <a href="/resume.pdf" download className="btn btn-outline" style={{ padding: '0.4rem 1rem', fontSize: '0.85rem' }}>
              <FaDownload /> Resume
            </a>
          </li>
        </ul>
      ...
      <main>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: '4rem', flexWrap: 'wrap-reverse' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
                <a href="https://github.com/Ayushkumar-4" className="btn btn-primary">Check out my work</a>
                <a href="https://github.com/Ayushkumar-4" target="_blank" rel="noreferrer" className="btn btn-outline"><FaGithub /> GitHub</a>
                <a href="https://www.linkedin.com/in/ayushkrr/" target="_blank" rel="noreferrer" className="btn btn-outline"><FaLinkedin /> LinkedIn</a>
              </div>
            </motion.div>
        ...
        <SectionWrapper id="about">
          ...
          <div className="grid-2">
            <div>
              ...
              <a href="/resume.pdf" download className="btn btn-outline" style={{ marginTop: '2rem' }}>
            ...
            {[
              {
                ...
                date: 'Jan 2024',
                image: '/dsa.png', // Replace with actual image path like '/dsa-cert.jpg'
              ...
              },
              {
                ...
                issuer: 'NPTEL',
                date: 'Feb 2024',
                image: '/cloud.png', // Replace with actual image path like '/cloud-cert.jpg'
        ...
        <SectionWrapper id="contact" className="contact">
          <div className="glass-card" style={{ textAlign: 'center', padding: '4rem 2rem' }}>
            ...
            <a href="mailto:aayushraunak4444@gmail.com" className="btn btn-primary" style={{ padding: '1rem 2rem' }}>
